                ...
                if (array_key_exists('values', $expose)) {
                    ...
                    switch ($ProfileName) {
                        ...
                        case 'Z2M.action.91e7a350':
                            if (!IPS_VariableProfileExists($ProfileName)) {
                                $this->RegisterProfileStringEx($ProfileName, 'Information', '', '', [
                                    ['region_1_enter', $this->Translate('Region * enter'), '', 0x00FF00],
                                    ['region_1_leave', $this->Translate('Region * leave'), '', 0x00FF00],
                                    ['region_1_occupied', $this->Translate('Region * occupied'), '', 0x00FF00],
                                    ['region_1_unoccupied', $this->Translate('Region * unoccupied'), '', 0x00FF00],
                                    ['region_2_enter', $this->Translate('Region * enter'), '', 0x00FF00],
                                    ['region_2_leave', $this->Translate('Region * leave'), '', 0x00FF00],
                                    ['region_2_occupied', $this->Translate('Region * occupied'), '', 0x00FF00],
                                    ['region_2_unoccupied', $this->Translate('Region * unoccupied'), '', 0x00FF00],
                                    ['region_3_enter', $this->Translate('Region * enter'), '', 0x00FF00],
                                    ['region_3_leave', $this->Translate('Region * leave'), '', 0x00FF00],
                                    ['region_3_occupied', $this->Translate('Region * occupied'), '', 0x00FF00],
                                    ['region_3_unoccupied', $this->Translate('Region * unoccupied'), '', 0x00FF00],
                                    ['region_4_enter', $this->Translate('Region * enter'), '', 0x00FF00],
                                    ['region_4_leave', $this->Translate('Region * leave'), '', 0x00FF00],
                                    ['region_4_occupied', $this->Translate('Region * occupied'), '', 0x00FF00],
                                    ['region_4_unoccupied', $this->Translate('Region * unoccupied'), '', 0x00FF00],
                                    ['region_5_enter', $this->Translate('Region * enter'), '', 0x00FF00],
                                    ['region_5_leave', $this->Translate('Region * leave'), '', 0x00FF00],
                                    ['region_5_occupied', $this->Translate('Region * occupied'), '', 0x00FF00],
                                    ['region_5_unoccupied', $this->Translate('Region * unoccupied'), '', 0x00FF00],
                                    ['region_6_enter', $this->Translate('Region * enter'), '', 0x00FF00],
                                    ['region_6_leave', $this->Translate('Region * leave'), '', 0x00FF00],
                                    ['region_6_occupied', $this->Translate('Region * occupied'), '', 0x00FF00],
                                    ['region_6_unoccupied', $this->Translate('Region * unoccupied'), '', 0x00FF00],
                                    ['region_7_enter', $this->Translate('Region * enter'), '', 0x00FF00],
                                    ['region_7_leave', $this->Translate('Region * leave'), '', 0x00FF00],
                                    ['region_7_occupied', $this->Translate('Region * occupied'), '', 0x00FF00],
                                    ['region_7_unoccupied', $this->Translate('Region * unoccupied'), '', 0x00FF00],
                                    ['region_8_enter', $this->Translate('Region * enter'), '', 0x00FF00],
                                    ['region_8_leave', $this->Translate('Region * leave'), '', 0x00FF00],
                                    ['region_8_occupied', $this->Translate('Region * occupied'), '', 0x00FF00],
                                    ['region_8_unoccupied', $this->Translate('Region * unoccupied'), '', 0x00FF00],
                                    ['region_9_enter', $this->Translate('Region * enter'), '', 0x00FF00],
                                    ['region_9_leave', $this->Translate('Region * leave'), '', 0x00FF00],
                                    ['region_9_occupied', $this->Translate('Region * occupied'), '', 0x00FF00],
                                    ['region_9_unoccupied', $this->Translate('Region * unoccupied'), '', 0x00FF00],
                                    ['region_10_enter', $this->Translate('Region * enter'), '', 0x00FF00],
                                    ['region_10_leave', $this->Translate('Region * leave'), '', 0x00FF00],
                                    ['region_10_occupied', $this->Translate('Region * occupied'), '', 0x00FF00],
                                    ['region_10_unoccupied', $this->Translate('Region * unoccupied'), '', 0x00FF00]
                                ]);
                            }
                            break;
